...
class Main
  ...
  # Perhaps to be run prior to calling the statistics method????
  # Scratch that.  Looks like this needs to be called prior to calling Tester::main
  def some_crazy_code_sitting_near_the_end
